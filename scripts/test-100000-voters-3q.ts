#!/usr/bin/env npx tsx
/**
 * Test script: 100,000 Voters with 3-Question Ballot
 *
 * Simulates a complete election with 100,000 voters:
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════════╗');
  console.log('║   TVS - 100,000 Voters × 3-Question Ballot E2E Test             ║');
  console.log('╚════════════════════════════════════════════════════════════════╝\n');
  ...
  const electionData = await api('/api/elections', {
    method: 'POST',
    body: JSON.stringify({
      name: '100K Voters - 3 Question Ballot Test',
  ...
  // ==========================================================================
  // Step 4: Register 100,000 Voters
  // ==========================================================================
  ...
  console.log('✅ 100,000 voter × 3 question E2E test completed!\n');
}
